...
from widgets import Frame, Label, Window, Button, Point, LabelStyle
...
label1 = Label(frame1, Point(75, 9), Point(86, 7), "Frame 1",
               style=LabelStyle(text_style=term.darkorange2, border_style=BorderStyle.SINGLE))
label2 = Label(frame2, Point(75, 9), Point(86, 7), "Frame 2",
               style=LabelStyle(text_style=term.darkgreen, border_style=BorderStyle.DOUBLE))
label3 = Label(frame3, Point(75, 9), Point(86, 7), "Frame 3",
               style=LabelStyle(text_style=term.red4, border_style=BorderStyle.SINGLE))
...
button1 = Button(buttonFrame, Point(64, 2), Point(75, 4), text="Frame 1", command=frame1toggle,
                 style=LabelStyle(term.on_darkorange2, term.white),
                 selected_style=LabelStyle(term.on_darkorange2, term.underline_yellow,
